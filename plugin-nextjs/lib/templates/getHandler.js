...
const makeHandler = (conf, app, pageRoot, staticManifest = [], mode = 'ssr') => {
    ...
    const getBridge = (event) => {
        console.log("hey, I'm getting the bridge!");
        if (bridge) {
            return bridge;
        }
    ...
    return async function handler(event, context) {
        var _a, _b, _c;
        console.log("hey, I'm in the handler!");
        ...
        console.log('bridge headers', JSON.stringify(headers, null, 2));
        ...
        console.log('mvh', JSON.stringify(multiValueHeaders, null, 2));
        if (requestMode === 'odb' || requestMode === 'isr') {
